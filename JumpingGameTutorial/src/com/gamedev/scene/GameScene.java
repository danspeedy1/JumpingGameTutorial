...
import com.gamedev.character.Player;
import com.gamedev.extras.LevelCompleteWindow;
import com.gamedev.extras.LevelCompleteWindow.StarsCount;
...
public class GameScene extends BaseScene implements IOnSceneTouchListener, SensorEventListener {
	...
	private void createHUD() {
		...
		// CREATE SCORE TEXT
		scoreText = new Text(0, camera.getHeight(), resourcesManager.font, "Score: 0123456789", new TextOptions(HorizontalAlign.LEFT), vbom);
		scoreText.setText("Score: 0");
		scoreText.setPosition(scoreText.getX() + (scoreText.getWidth() / 2), scoreText.getY() - (scoreText.getHeight() / 2));
	...
	private void loadLevel(int levelID) {
		...
		levelLoader.registerEntityLoader(new EntityLoader<SimpleLevelEntityLoaderData>(LevelConstants.TAG_LEVEL) {
			public IEntity onLoadEntity(final String pEntityName, final IEntity pParent, final Attributes pAttributes, final SimpleLevelEntityLoaderData pSimpleLevelEntityLoaderData)
				...
				// TODO later we will specify camera BOUNDS and create invisible
				// walls
